...
//		analysis.calculateKLDPerPerson(true);
//		analysis.calculateKLDPerPerson(false);
...
//		analysis.calculateKLDPerDepartment(true);
//		analysis.calculateKLDPerDepartment(false);
...
//		analysis.calculateAverageKLDOfSortedHistogramPerDepartment();
		analysis.calculateKLDPerPerson(true, false);
	}
}
